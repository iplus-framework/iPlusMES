...
{
    /// <summary>
    /// Converter-Class for PAEActuator2way_3pos
    /// </summary>
    [ACClassInfo(ConstGIP2006.PackName_VarioGIP2006, "en{'GIPConv2006Act2Way_3pos'}de{'GIPConv2006Act2Way_3pos'}", Global.ACKinds.TPABGModule, Global.ACStorableTypes.NotStorable, false, false)]
    public class GIPConv2006Act2Way_3pos : GIPConv2006Actuator
    {
        #region c'tors
        public GIPConv2006Act2Way_3pos(gip.core.datamodel.ACClass acType, IACObject content, IACObject parentACObject, ACValueList parameter, string acIdentifier="")
        ...
        protected override void ModelProperty_ValueUpdatedOnReceival(object sender, ACPropertyChangedEventArgs e, ACPropertyChangedPhase phase)
        {
            ...
            if (sender == ReqPos2)
            {
                if (!_LockResend_ReqRunState && (ReqPos1 != null))
                {
                    ...
                    else if (ReqPos1.ValueT && !ReqPos2.ValueT) // Position 1 / Links
                    {
                        Request.ValueT.Bit03_Pos3Mid = false;
                        Request.ValueT.Bit02_Pos2Open = false;
                        Request.ValueT.Bit00_Pos1Close = true;
                    }
                    else // Close / Richtung3 / Unten
                    {
