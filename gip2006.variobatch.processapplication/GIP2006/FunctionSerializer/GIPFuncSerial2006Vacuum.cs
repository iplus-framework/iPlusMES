...
{
    [ACClassInfo(Const.PackName_VarioAutomation, "en{'Serializer for Vacuum'}de{'Serialisierer für Vakuum'}", Global.ACKinds.TACDAClass, Global.ACStorableTypes.Required, false, false)]
