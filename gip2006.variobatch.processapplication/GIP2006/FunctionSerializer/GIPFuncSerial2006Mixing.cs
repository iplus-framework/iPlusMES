...
{
    [ACClassInfo(Const.PackName_VarioAutomation, "en{'Serializer for Mixing'}de{'Serialisierer für Mischen'}", Global.ACKinds.TACDAClass, Global.ACStorableTypes.Required, false, false)]
