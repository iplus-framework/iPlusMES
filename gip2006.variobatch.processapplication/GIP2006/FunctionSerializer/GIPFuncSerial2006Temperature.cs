...
{
    [ACClassInfo("gip.VarioAutomation", "en{'Serializer for Temperature reg.'}de{'Serialisierer für Temperieren'}", Global.ACKinds.TACDAClass, Global.ACStorableTypes.NotStorable, false, false, "", "", 9999)]
    public class GIPFuncSerial2006Temperature : ACSessionObjSerializer
    {
        public GIPFuncSerial2006Temperature(ACClass acType, IACObject content, IACObject parentACObject, ACValueList parameter, string acIdentifier = "") :
