...
namespace gip.bso.purchasing
{
    ...
    public class BSOInDeliveryNote : ACBSOvbNav
    {
        ...
        public IEnumerable<InOrderPos> InOrderPosFromPickingList
        {
            get
            {
                var query = DatabaseApp.PickingPos.AsEnumerable().Where(c => (c.Picking.PickingType == GlobalApp.PickingType.ReceiptVehicle || c.Picking.PickingType == GlobalApp.PickingType.ReceiptVehicle)
                                                          && c.InOrderPos != null
