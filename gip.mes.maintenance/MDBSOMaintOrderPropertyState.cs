...
namespace gip.mes.maintenance
{
    ...
    public class MDBSOMaintOrderPropertyState : ACBSOvbNav
    {
        ...
        public void Delete()
        {
            ...
            Load();
            PostExecute("Delete");
            OnPropertyChanged(nameof(MaintOrderPropertyStateList));
        }
        ...
        public override IEnumerable<string> GetPropsToObserveForIsEnabled(string acMethodName)
        {
            switch (acMethodName)
            {
                ...
                case nameof(Load):
                case nameof(IsEnabledLoad):
                    return new string[] { nameof(SelectedMaintOrderPropertyState) };
                #endregion
                ...
                case nameof(Delete):
                case nameof(IsEnabledDelete):
                    return new string[] { nameof(CurrentMaintOrderPropertyState) };
                #endregion
