...
//        private MaintTypeInfo AddMaintRuleToCache(MaintACClass maintACClass)
//        {
...
//                {
//                    core.datamodel.ACClass iPlusACClass = maintACClass.GetACClass(this.Root.Database.ContextIPlus);
...
//        {
//            if (!(maintRule.MaintACClass.MDMaintMode.MaintMode == MDMaintMode.MaintModes.TimeOnly || maintRule.MaintACClass.MDMaintMode.MaintMode == MDMaintMode.MaintModes.TimeAndEvent))
//                return;
...
//        private void ApplyEventBasedRuleToInstances(MaintACClassProperty maintACClassProperty, ApplicationManager appManager)
//        {
...
//                                                    .ToDictionary(c => c.MaintACClass.VBiACClassID);
