...
namespace gip.mes.maintenance
{
    ...
    public class MDBSOMaintOrderState : ACBSOvbNav 
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction("MDMaintOrderState", Const.New, (short)MISort.New, true, "SelectedMaintOrderState", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
            if (!PreExecute("New")) return;
            CurrentMaintOrderState = MDMaintOrderState.NewACObject(DatabaseApp, null);
            DatabaseApp.MDMaintOrderState.AddObject(CurrentMaintOrderState);
            ACState = Const.SMNew;
            PostExecute("New");
        ...
        /// </summary>
        [ACMethodInteraction("MDMaintOrderState", Const.Delete, (short)MISort.Delete, true, "CurrentMaintOrderState", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
        ...
        public void Search()
        {
            ...
            OnPropertyChanged("MaintOrderStateList");
        }
        ...
        public override IEnumerable<string> GetPropsToObserveForIsEnabled(string acMethodName)
        {
            switch (acMethodName)
            {
                ...
                case nameof(Load):
                case nameof(IsEnabledLoad):
                    return new string[] { nameof(SelectedMaintOrderState) };
                #endregion
                ...
                case nameof(Delete):
                case nameof(IsEnabledDelete):
                    return new string[] { nameof(CurrentMaintOrderState) };
                #endregion
