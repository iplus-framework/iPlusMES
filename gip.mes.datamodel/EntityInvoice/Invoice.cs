...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(5, nameof(Invoice.CustomerCompany), ConstApp.Company, Const.ContextDatabase + "\\" + Company.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(6, nameof(Invoice.CustRequestNo), "en{'Extern Invoice No.'}de{'Externe Rechnungsnummer'}", "", "", true)]
    [ACPropertyEntity(7, nameof(Invoice.DeliveryCompanyAddress), "en{'Delivery Address'}de{'Lieferadresse'}", Const.ContextDatabase + "\\" + CompanyAddress.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(8, nameof(Invoice.BillingCompanyAddress), "en{'Billing Address'}de{'Rechnungsadresse'}", Const.ContextDatabase + "\\" + CompanyAddress.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(22, nameof(Invoice.Invoice1_ReferenceInvoice), "en{'Reference Invoice'}de{'Referenzrechnung'}", Const.ContextDatabase + "\\" + Invoice.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
