...
{
    internal partial class FacilityChargeEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var cPartnerCompanyMaterialID = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            cPartnerCompanyMaterialID.TypeMapping = GuidTypeMapping.Default.Clone(
                comparer: new ValueComparer<Guid?>(
            ...
            var facilityChargeSortNo = runtimeEntityType.AddProperty(
                ...
                sentinel: 0);
            facilityChargeSortNo.TypeMapping = IntTypeMapping.Default.Clone(
            ...
            var handlingUnit = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            handlingUnit.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    (string v1, string v2) => v1 == v2,
                    (string v) => v.GetHashCode(),
                    (string v) => v),
            ...
            var splitNo = runtimeEntityType.AddProperty(
                ...
                sentinel: 0);
            splitNo.TypeMapping = IntTypeMapping.Default.Clone(
                comparer: new ValueComparer<int>(
                    (int v1, int v2) => v1 == v2,
                    (int v) => v,
                    (int v) => v),
            ...
            var stockQuantityUOM = runtimeEntityType.AddProperty(
                ...
                sentinel: 0.0);
            stockQuantityUOM.TypeMapping = SqlServerDoubleTypeMapping.Default.Clone(
                comparer: new ValueComparer<double>(
                    (double v1, double v2) => v1.Equals(v2),
                    (double v) => v.GetHashCode(),
                    (double v) => v),
            ...
            var stockQuantityUOMAmb = runtimeEntityType.AddProperty(
                ...
                sentinel: 0.0);
            stockQuantityUOMAmb.TypeMapping = SqlServerDoubleTypeMapping.Default.Clone(
                comparer: new ValueComparer<double>(
                    (double v1, double v2) => v1.Equals(v2),
                    (double v) => v.GetHashCode(),
                    (double v) => v),
