...
namespace gip.mes.datamodel
{
    internal partial class MaintOrderPropertyEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            maintOrderPropertyID.TypeMapping = GuidTypeMapping.Default.Clone(
            ...
            var actValue = runtimeEntityType.AddProperty(
                ...
                unicode: false);
            actValue.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
            ...
            var setValue = runtimeEntityType.AddProperty(
                ...
                unicode: false);
            setValue.TypeMapping = SqlServerStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    (string v1, string v2) => v1 == v2,
                    (string v) => v.GetHashCode(),
                    (string v) => v),
