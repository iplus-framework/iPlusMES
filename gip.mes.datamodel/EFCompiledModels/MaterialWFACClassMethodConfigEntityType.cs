...
namespace gip.mes.datamodel
{
    internal partial class MaterialWFACClassMethodConfigEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            materialWFACClassMethodConfigID.TypeMapping = GuidTypeMapping.Default.Clone(
            ...
            var parentMaterialWFACClassMethodConfigID = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            parentMaterialWFACClassMethodConfigID.TypeMapping = GuidTypeMapping.Default.Clone(
                comparer: new ValueComparer<Guid?>(
                    (Nullable<Guid> v1, Nullable<Guid> v2) => v1.HasValue && v2.HasValue && (Guid)v1 == (Guid)v2 || !v1.HasValue && !v2.HasValue,
                    (Nullable<Guid> v) => v.HasValue ? ((Guid)v).GetHashCode() : 0,
                    (Nullable<Guid> v) => v.HasValue ? (Nullable<Guid>)(Guid)v : default(Nullable<Guid>)),
