...
{
    internal partial class OutOfferPosEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            outOfferPosID.TypeMapping = GuidTypeMapping.Default.Clone(
            ...
            var groupOutOfferPosID = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            groupOutOfferPosID.TypeMapping = GuidTypeMapping.Default.Clone(
                comparer: new ValueComparer<Guid?>(
            ...
            var inRecalculation = runtimeEntityType.AddProperty(
                ...
                sentinel: false);
            inRecalculation.TypeMapping = SqlServerBoolTypeMapping.Default.Clone(
                comparer: new ValueComparer<bool>(
                    (bool v1, bool v2) => v1 == v2,
                    (bool v) => v.GetHashCode(),
                    (bool v) => v),
            ...
            var parentOutOfferPosID = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            parentOutOfferPosID.TypeMapping = GuidTypeMapping.Default.Clone(
                comparer: new ValueComparer<Guid?>(
                    (Nullable<Guid> v1, Nullable<Guid> v2) => v1.HasValue && v2.HasValue && (Guid)v1 == (Guid)v2 || !v1.HasValue && !v2.HasValue,
                    (Nullable<Guid> v) => v.HasValue ? ((Guid)v).GetHashCode() : 0,
                    (Nullable<Guid> v) => v.HasValue ? (Nullable<Guid>)(Guid)v : default(Nullable<Guid>)),
