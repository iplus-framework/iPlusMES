...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(11, MDTimeRange.ClassName, "en{'Time Range'}de{'Zeitraum'}", Const.ContextDatabase + "\\" + MDTimeRange.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(12, "PriceNet", ConstApp.PriceNet, "", "", true)]
    [ACPropertyEntity(13, "PriceGross", ConstApp.PriceGross, "", "", true)]
    [ACPropertyEntity(14, MDCountrySalesTax.ClassName, "en{'Sales Tax'}de{'Umsatzsteuer'}", Const.ContextDatabase + "\\" + MDCountrySalesTax.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
