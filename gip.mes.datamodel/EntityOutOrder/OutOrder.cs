...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(4, MDOutOrderType.ClassName, "en{'Sales Order Type'}de{'Auftragsart'}", Const.ContextDatabase + "\\" + MDOutOrderType.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(5, MDOutOrderState.ClassName, "en{'Sales Order Status'}de{'Lieferstatus'}", Const.ContextDatabase + "\\" + MDOutOrderState.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(6, "CustomerCompany", ConstApp.Company, Const.ContextDatabase + "\\" + Company.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(16, "BasedOnOutOffering", "en{'Sales Offer'}de{'Angebot'}", Const.ContextDatabase + "\\" + OutOffer.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(19, ConstApp.IssuerCompanyAddress, ConstApp.IssuerCompanyAddress_ACCaption, Const.ContextDatabase + "\\" + CompanyAddress.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
