...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(6, MaintACClassProperty.ClassName, "en{'Maintenance property'}de{'Wartungseigenschaft'}", Const.ContextDatabase + "\\" + MaintACClassProperty.ClassName, "", true)]
