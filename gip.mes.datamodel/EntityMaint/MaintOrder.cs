...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(6, "MDMaintOrderState", "en{'Status'}de{'Status'}", Const.ContextDatabase + "\\" + MDMaintOrderState.ClassName, "", true)]
    ...
    [ACPropertyEntity(10, "WarningDiff", "en{'Advance Notice Days'}de{'Vorankündigung Tage'}", "", "", true)]
    [ACPropertyEntity(11, "PlannedStartDate", "en{'Planned start date'}de{'Geplantes Startdatum'}", "", "", true)]
    [ACPropertyEntity(12, "MaintOrder1_BasedOnMaintOrder", "en{'BasedOnMaintOrder'}de{'BasedOnMaintOrder'}", Const.ContextDatabase + "\\" + MaintOrder.ClassName, "", true)]
    [ACPropertyEntity(13, "Facility", "en{'Facility'}de{'Facility'}", Const.ContextDatabase + "\\" + Facility.ClassName, "", true)]
    [ACPropertyEntity(14, "Picking", "en{'Picking'}de{'Picking'}", Const.ContextDatabase + "\\" + Picking.ClassName, "", true)]
