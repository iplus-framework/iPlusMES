...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(1, nameof(PlanningMR), ConstApp.PlanningMR, Const.ContextDatabase + "\\" + PlanningMR.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(2, nameof(Material), ConstApp.Material, Const.ContextDatabase + "\\" + Material.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
