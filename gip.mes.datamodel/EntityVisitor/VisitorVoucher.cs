...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(1, nameof(VisitorVoucherNo), "en{'Visitor Voucher No.'}de{'Besucherbeleg-Nr.'}", MinValue = 1, MaxValue = Int32.MaxValue)]
    [ACPropertyEntity(2, nameof(CheckInDate), "en{'Check-in date'}de{'Anmeldedatum'}", "", "", true)]
    [ACPropertyEntity(3, nameof(CheckOutDate), "en{'Check-out date'}de{'Abmeldedatum'}", "", "", true)]
    ...
    [ACPropertyEntity(6, nameof(TotalWeight), "en{'Total Weight'}de{'Gewicht beladen'}", "", "", true)]
    [ACPropertyEntity(7, nameof(EmptyWeight), "en{'Empty Weight'}de{'Gewicht leer'}", "", "", true)]
    [ACPropertyEntity(8, nameof(NetWeight), "en{'Net Weight'}de{'Nettogewicht'}", "", "", true)]
    [ACPropertyEntity(9, nameof(LossWeight), "en{'Loss Weight'}de{'Schwund'}", "", "", true)]
    [ACPropertyEntity(10, nameof(VehicleFacility), "en{'Vehicle'}de{'Fahrzeug'}", Const.ContextDatabase + "\\" + Facility.ClassName, "", true)]
    [ACPropertyEntity(11, nameof(TrailerFacility), "en{'Trailer'}de{'Anhänger'}", Const.ContextDatabase + "\\" + Facility.ClassName, "", true)]
    [ACPropertyEntity(12, nameof(VisitorCompany), "en{'Visitor Company'}de{'Besucher Unternehmen'}", Const.ContextDatabase + "\\" + Company.ClassName, "", true)]
    [ACPropertyEntity(13, nameof(VisitorCompanyPerson), "en{'Visitor Company Person'}de{'Besucher'}", Const.ContextDatabase + "\\" + CompanyPerson.ClassName, "", true)]
    [ACPropertyEntity(12, nameof(Comment), "en{'Comment'}de{'Kommentar'}", "", "", true)]
