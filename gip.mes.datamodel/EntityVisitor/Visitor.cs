...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(3, "VisitorCompany", "en{'Company'}de{'Unternehmen'}", Const.ContextDatabase + "\\" + Company.ClassName, "", true)]
    [ACPropertyEntity(4, "VisitorCompanyPerson", "en{'Visitor'}de{'Besucher'}", Const.ContextDatabase + "\\" + CompanyPerson.ClassName, "", true)]
    [ACPropertyEntity(5, MDVisitorCard.ClassName, "en{'Chipcard'}de{'Chipkarte'}", Const.ContextDatabase + "\\" + MDVisitorCard.ClassName, "", true)]
    [ACPropertyEntity(6, "VehicleFacility", "en{'Vehicle'}de{'Fahrzeug'}", Const.ContextDatabase + "\\" + Facility.ClassName, "", true)]
    [ACPropertyEntity(7, "TrailerFacility", "en{'Trailer'}de{'Anhänger'}", Const.ContextDatabase + "\\" + Facility.ClassName, "", true)]
    ...
    [ACPropertyEntity(12, "VisitedCompany", "en{'Visited Company'}de{'Besuchtes Unternehmen'}", Const.ContextDatabase + "\\" + Company.ClassName, "", true)]
    [ACPropertyEntity(13, Material.ClassName, "en{'Material'}de{'Material'}", Const.ContextDatabase + "\\" + Material.ClassName, "", true)]
