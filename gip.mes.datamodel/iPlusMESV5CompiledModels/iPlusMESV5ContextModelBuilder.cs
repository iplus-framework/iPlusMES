...
namespace gip.mes.datamodel
{
    public partial class iPlusMESV5ContextModel
    {
        partial void Initialize()
        {
            ...
            var maintACClassVBGroup = MaintACClassVBGroupEntityType.Create(this);
            var maintOrder = MaintOrderEntityType.Create(this);
            var maintOrderProperty = MaintOrderPropertyEntityType.Create(this);
            var maintTask = MaintTaskEntityType.Create(this);
            ...
            MaintACClassEntityType.CreateForeignKey1(maintACClass, mDMaintMode);
            MaintACClassEntityType.CreateForeignKey2(maintACClass, aCClass);
            ...
            MaintACClassVBGroupEntityType.CreateForeignKey1(maintACClassVBGroup, maintACClass);
            MaintACClassVBGroupEntityType.CreateForeignKey2(maintACClassVBGroup, maintACClassProperty);
            MaintACClassVBGroupEntityType.CreateForeignKey3(maintACClassVBGroup, vBGroup);
            MaintOrderEntityType.CreateForeignKey1(maintOrder, mDMaintMode);
            MaintOrderEntityType.CreateForeignKey2(maintOrder, mDMaintOrderState);
            MaintOrderEntityType.CreateForeignKey3(maintOrder, maintACClass);
            MaintOrderEntityType.CreateForeignKey4(maintOrder, aCClass);
            ...
            MaintTaskEntityType.CreateForeignKey1(maintTask, mDMaintTaskState);
            MaintTaskEntityType.CreateForeignKey2(maintTask, maintACClassVBGroup);
            MaintTaskEntityType.CreateForeignKey3(maintTask, maintOrder);
            ...
            PickingPosEntityType.CreateForeignKey1(pickingPos, facility);
            PickingPosEntityType.CreateForeignKey2(pickingPos, inOrderPos);
            PickingPosEntityType.CreateForeignKey3(pickingPos, mDDelivPosLoadState);
            PickingPosEntityType.CreateForeignKey4(pickingPos, outOrderPos);
            PickingPosEntityType.CreateForeignKey5(pickingPos, picking);
            PickingPosEntityType.CreateForeignKey6(pickingPos, material);
            PickingPosEntityType.CreateForeignKey7(pickingPos, facility);
            ...
            MaintACClassVBGroupEntityType.CreateAnnotations(maintACClassVBGroup);
            MaintOrderEntityType.CreateAnnotations(maintOrder);
            MaintOrderPropertyEntityType.CreateAnnotations(maintOrderProperty);
            MaintTaskEntityType.CreateAnnotations(maintTask);
