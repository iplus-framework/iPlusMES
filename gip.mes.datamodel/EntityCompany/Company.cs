...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(13, "BillingMDTermOfPayment", "en{'Billing Term of Payment'}de{'Zahlungsziel der Fakturierung'}", Const.ContextDatabase + "\\" + MDTermOfPayment.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(16, "ShippingMDTermOfPayment", "en{'Shipping Term of Payment'}de{'Zahlungsbedingungen für den Versand'}", Const.ContextDatabase + "\\" + MDTermOfPayment.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(17, MDCurrency.ClassName, "en{'Currency'}de{'Währung'}", Const.ContextDatabase + "\\" + MDCurrency.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(23, nameof(WebUrl), "en{'Web address'}de{'Webadresse'}", "", "", true)]
    [ACPropertyEntity(496, Const.EntityInsertDate, Const.EntityTransInsertDate)]
    [ACPropertyEntity(497, Const.EntityInsertName, Const.EntityTransInsertName)]
    [ACPropertyEntity(498, Const.EntityUpdateDate, Const.EntityTransUpdateDate)]
    [ACPropertyEntity(499, Const.EntityUpdateName, Const.EntityTransUpdateName)]
    [ACPropertyEntity(9999, "Company1_ParentCompany", "en{'Parent Company'}de{'Muttergesellschaft'}", Const.ContextDatabase + "\\" + Company.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
