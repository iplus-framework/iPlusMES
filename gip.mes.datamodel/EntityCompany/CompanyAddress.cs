...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(6, MDCountry.ClassName, "en{'Country'}de{'Land'}", Const.ContextDatabase + "\\" + MDCountry.ClassName, "", true)]
    [ACPropertyEntity(7, MDCountryLand.ClassName, "en{'Federal State'}de{'Bundesland'}", Const.ContextDatabase + "\\" + MDCountryLand.ClassName, "", true)]
