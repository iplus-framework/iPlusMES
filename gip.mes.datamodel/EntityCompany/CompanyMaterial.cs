...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(1, nameof(CompanyMaterialNo), "en{'External Material-No.'}de{'Externe Material-Nr.'}", "", "", true, MinLength = 1)]
    [ACPropertyEntity(2, nameof(CompanyMaterialName), "en{'External Material Name'}de{'Externer Materialname'}", "", "", true)]
    ...
    [ACPropertyEntity(13, nameof(Tax), "en{'Taxed'}de{'Versteuert'}", "", "", true)]
