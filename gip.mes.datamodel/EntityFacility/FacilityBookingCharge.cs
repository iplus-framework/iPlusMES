...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(12, "InwardMaterial", "en{'Material (Inward Post)'}de{'Material (Zugangsbuchung)'}", Const.ContextDatabase + "\\" + Material.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(13, "InwardFacility", "en{'Storage Bin (Inward post)'}de{'Lagerplatz (Zugangsbuchung)'}", Const.ContextDatabase + "\\" + Facility.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(21, "OutwardFacility", "en{'Storage Bin (Outward Post)'}de{'Lagerplatz (Ausgangsbuchung)'}", Const.ContextDatabase + "\\" + Facility.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(22, "OutwardFacilityLot", "en{'Lot/Charge (Outward Post)'}de{'Los/Charge (Ausgangsbuchung)'}", Const.ContextDatabase + "\\" + FacilityLot.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(23, "OutwardFacilityCharge", "en{'Quant (Outward Post)'}de{'Quant (Ausgangsbuchung)'}", Const.ContextDatabase + "\\" + FacilityCharge.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(24, "OutwardFacilityLocation", "en{'Storage Location (Outward Post)'}de{'Lagerort (Ausgangsbuchung)'}", Const.ContextDatabase + "\\" + Facility.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(25, "OutwardPartslist", "en{'Outward Bill of Materials'}de{'Ausgang Stückliste'}", Const.ContextDatabase + "\\" + Partslist.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(26, "OutwardCompanyMaterialID", "en{'Manufact. Material (Out)'}de{'Materialhersteller (Ausg.)'}", Const.ContextDatabase + "\\" + CompanyMaterial.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(27, "OutwardCPartnerCompMatID", "en{'Contr. Partner Material (Out)'}de{'Vertragspart. Material (Ausg.)'}", Const.ContextDatabase + "\\" + CompanyMaterial.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(28, MDBookingNotAvailableMode.ClassName, "en{'Mode for Zero Stock'}de{'Modus bei Nullbestand'}", Const.ContextDatabase + "\\" + MDBookingNotAvailableMode.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(31, MDBalancingMode.ClassName, "en{'Balancing Mode'}de{'Bilanzierungsmodus'}", Const.ContextDatabase + "\\" + MDBalancingMode.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(34, MDZeroStockState.ClassName, "en{'Set to zero Stock'}de{'Auf Nullbestand setzen'}", Const.ContextDatabase + "\\" + MDZeroStockState.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(35, MDReleaseState.ClassName, ConstApp.ESReleaseState, Const.ContextDatabase + "\\" + MDReleaseState.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(36, "SetCompleted", ConstApp.SetCompleted, "", "", true)]
    [ACPropertyEntity(37, MDReservationMode.ClassName, ConstApp.ESReservationMode, Const.ContextDatabase + "\\" + MDReservationMode.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(38, MDMovementReason.ClassName, ConstApp.ESMovementReason, Const.ContextDatabase + "\\" + MDMovementReason.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(46, CompanyMaterial.ClassName, "en{'Material manufact.'}de{'Materialhersteller'}", Const.ContextDatabase + "\\" + CompanyMaterial.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(47, InOrderPos.ClassName, "en{'Inorderpos'}de{'Bestellposition'}", Const.ContextDatabase + "\\" + InOrderPos.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(48, OutOrderPos.ClassName, "en{'Outorderpos'}de{'Auftragsposition'}", Const.ContextDatabase + "\\" + OutOrderPos.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(54, ProdOrderPartslistPos.ClassName, "en{'Bill of Materials line'}de{'Stücklistenposition'}", Const.ContextDatabase + "\\" + ProdOrderPartslistPos.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(55, ProdOrderPartslistPosRelation.ClassName, "en{'Bill of Materials relation'}de{'Entnahmeposition'}", Const.ContextDatabase + "\\" + ProdOrderPartslistPosRelation.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(56, PickingPos.ClassName, "en{'Picking line'}de{'Kommissionierposition'}", Const.ContextDatabase + "\\" + PickingPos.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(9999, FacilityBooking.ClassName, "en{'Stock movement'}de{'Lagerbewegung'}", Const.ContextDatabase + "\\" + FacilityBooking.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
