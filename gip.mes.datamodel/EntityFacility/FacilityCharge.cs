...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(1, FacilityLot.ClassName, ConstApp.Lot, Const.ContextDatabase + "\\" + FacilityLot.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(2, "SplitNo", "en{'Split No.'}de{'Splitnr'}", "", "", true)]
    [ACPropertyEntity(3, MDReleaseState.ClassName, ConstApp.ESReleaseState, Const.ContextDatabase + "\\" + MDReleaseState.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(5, "Partslist", ConstApp.BOM, Const.ContextDatabase + "\\" + Partslist.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(12, MDUnit.ClassName, "en{'Unit of Measurement(UOM)'}de{'Maßeinheit(ME)'}", Const.ContextDatabase + "\\" + MDUnit.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(13, CompanyMaterial.ClassName, "en{'Material Manufact.'}de{'Materialhersteller'}", Const.ContextDatabase + "\\" + CompanyMaterial.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    // 12 ReservedQuantity
    ...
    [ACPropertyEntity(45, Facility.ClassName, ConstApp.Facility, Const.ContextDatabase + "\\" + Facility.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(46, "FacilityChargeSortNo", "en{'Charge Sort No.'}de{'Chargensortiernr'}", "", "", true)]
    [ACPropertyEntity(52, "CPartnerCompanyMaterial", "en{'Contractual Partner'}de{'Vertragspartner'}", Const.ContextDatabase + "\\" + CompanyMaterial.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    public partial class FacilityCharge
    {
        ...
        public static IQueryable<FacilityChargeModel> GetFacilityChargeModelList(DatabaseApp dbApp, IQueryable<FacilityCharge> fcs)
        {
            ...
            .Select(c => new FacilityChargeModel()
            {
                ...
                ProdOrderInsertDate = (c.IntermediateItem != null) ? c.IntermediateItem.ProdOrderPartslist.ProdOrder.InsertDate : new DateTime(1753, 1, 1),
