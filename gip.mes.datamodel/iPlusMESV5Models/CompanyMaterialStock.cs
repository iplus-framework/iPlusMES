...
public partial class CompanyMaterialStock : VBEntityObject, IInsertInfo, IUpdateInfo
{
    ...
    private CompanyMaterialStock(ILazyLoader lazyLoader)
    {
    ...
    Guid _CompanyMaterialStockID;
    public Guid CompanyMaterialStockID 
    {
        get { return _CompanyMaterialStockID; }
        set { SetProperty<Guid>(ref _CompanyMaterialStockID, value); }
    }
    ...
    double _AverageProdQuantity;
    public double AverageProdQuantity 
    {
        get { return _AverageProdQuantity; }
        set { SetProperty<double>(ref _AverageProdQuantity, value); }
    }
