...
public partial class MaterialStock : VBEntityObject , IInsertInfo, IUpdateInfo
{
    ...
    private MaterialStock(ILazyLoader lazyLoader)
    {
        LazyLoader = lazyLoader;
    }

    private ILazyLoader LazyLoader { get; set; }
    Guid _MaterialStockID;
    public Guid MaterialStockID 
    {
        get { return _MaterialStockID; }
        set { SetProperty<Guid>(ref _MaterialStockID, value); }
    }
