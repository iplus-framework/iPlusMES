...
public partial class FacilityStock : VBEntityObject , IInsertInfo, IUpdateInfo
{
    ...
    private FacilityStock(ILazyLoader lazyLoader)
    {
        LazyLoader = lazyLoader;
    }

    private ILazyLoader LazyLoader { get; set; }
    Guid _FacilityStockID;
    public Guid FacilityStockID 
    {
        get { return _FacilityStockID; }
        set { SetProperty<Guid>(ref _FacilityStockID, value); }
    }
    ...
    double _ToleranceMinus;
    public double ToleranceMinus 
    {
        get { return _ToleranceMinus; }
        set { SetProperty<double>(ref _ToleranceMinus, value); }
    }

    double _TolerancePlus;
    public double TolerancePlus 
    {
        get { return _TolerancePlus; }
        set { SetProperty<double>(ref _TolerancePlus, value); }
    }
