...
public partial class TandTv3MixPointFacilityPreBooking : VBEntityObject
{
    ...
    public Guid FacilityPreBookingID 
    {
        ...
        set { SetForeignKeyProperty<Guid>(ref _FacilityPreBookingID, value, "FacilityPreBooking", _FacilityPreBooking, FacilityPreBooking != null ? FacilityPreBooking.FacilityPreBookingID : default(Guid)); }
    }

    private FacilityPreBooking _FacilityPreBooking;
    public virtual FacilityPreBooking FacilityPreBooking
    { 
        get { return LazyLoader.Load(this, ref _FacilityPreBooking); } 
        set { SetProperty<FacilityPreBooking>(ref _FacilityPreBooking, value); }
    }
    ...
    public bool FacilityPreBooking_IsLoaded
    {
        get
        {
            return _FacilityPreBooking != null;
        }
    }
