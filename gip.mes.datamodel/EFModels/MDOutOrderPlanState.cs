...
public partial class MDOutOrderPlanState : VBEntityObject, IInsertInfo, IUpdateInfo, IMDTrans
{
    ...
    public virtual ICollection<OutOrderPos> OutOrderPos_MDOutOrderPlanState
    {
        ...
        set { SetProperty<ICollection<OutOrderPos>>(ref _OutOrderPos_MDOutOrderPlanState, value); }
    }
    ...
    public virtual CollectionEntry<MDOutOrderPlanState, OutOrderPos> OutOrderPos_MDOutOrderPlanStateReference
    {
