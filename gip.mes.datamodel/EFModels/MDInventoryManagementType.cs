...
public partial class MDInventoryManagementType : VBEntityObject, IInsertInfo, IUpdateInfo, IMDTrans
{

    public MDInventoryManagementType()
    {
    }

    private MDInventoryManagementType(ILazyLoader lazyLoader)
    {
    ...
    short _MDInventoryManagementTypeIndex;
    public short MDInventoryManagementTypeIndex 
    {
        get { return _MDInventoryManagementTypeIndex; }
        set { SetProperty<short>(ref _MDInventoryManagementTypeIndex, value); }
    }
