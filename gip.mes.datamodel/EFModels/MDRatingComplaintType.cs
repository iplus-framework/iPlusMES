...
public partial class MDRatingComplaintType : VBEntityObject, IInsertInfo, IUpdateInfo, IMDTrans
{

    public MDRatingComplaintType()
    {
    }

    private MDRatingComplaintType(ILazyLoader lazyLoader)
    {
