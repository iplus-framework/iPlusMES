...
public partial class MDLabOrderPosState : VBEntityObject, IInsertInfo, IUpdateInfo, IMDTrans
{
    ...
    public virtual ICollection<LabOrderPos> LabOrderPos_MDLabOrderPosState
    {
        ...
        set { SetProperty<ICollection<LabOrderPos>>(ref _LabOrderPos_MDLabOrderPosState, value); }
    }
    ...
    public virtual CollectionEntry<MDLabOrderPosState, LabOrderPos> LabOrderPos_MDLabOrderPosStateReference
    {
