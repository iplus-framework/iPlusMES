...
public partial class MDFacilityInventoryState : VBEntityObject, IInsertInfo, IUpdateInfo, IMDTrans
{
    ...
    {
        get { return LazyLoader.Load(this, ref _FacilityInventory_MDFacilityInventoryState); }
        set { SetProperty<ICollection<FacilityInventory>>(ref _FacilityInventory_MDFacilityInventoryState, value); }
    }
    ...
    public virtual CollectionEntry<MDFacilityInventoryState, FacilityInventory> FacilityInventory_MDFacilityInventoryStateReference
    {
