...
public partial class OutOrder : VBEntityObject, IInsertInfo, IUpdateInfo
{
    ...
    public Guid? BasedOnOutOfferID 
    {
        ...
        set { SetForeignKeyProperty<Guid?>(ref _BasedOnOutOfferID, value, "BasedOnOutOffer", _BasedOnOutOffer, BasedOnOutOffer != null ? BasedOnOutOffer.OutOfferID : default(Guid?)); }
    }
    ...
    public Guid MDOutOrderStateID 
    {
        ...
        set { SetForeignKeyProperty<Guid>(ref _MDOutOrderStateID, value, "MDOutOrderState", _MDOutOrderState, MDOutOrderState != null ? MDOutOrderState.MDOutOrderStateID : default(Guid)); }
    }
    ...
    public virtual ICollection<Invoice> Invoice_OutOrder
    {
        ...
        set { SetProperty<ICollection<Invoice>>(ref _Invoice_OutOrder, value); }
    }
    ...
    public virtual ICollection<OutOrderConfig> OutOrderConfig_OutOrder
    {
        ...
        set { SetProperty<ICollection<OutOrderConfig>>(ref _OutOrderConfig_OutOrder, value); }
    }
    ...
    public virtual ICollection<OutOrderPos> OutOrderPos_OutOrder
    {
        ...
        set { SetProperty<ICollection<OutOrderPos>>(ref _OutOrderPos_OutOrder, value); }
    }
