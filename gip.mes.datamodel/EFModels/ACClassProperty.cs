...
public partial class ACClassProperty : VBEntityObject, IInsertInfo, IUpdateInfo
{
    ...
    {
        get { return LazyLoader.Load(this, ref _MaintACClassProperty_VBiACClassProperty); }
        set { SetProperty<ICollection<MaintACClassProperty>>(ref _MaintACClassProperty_VBiACClassProperty, value); }
    }
    ...
    public bool MaintACClassProperty_VBiACClassProperty_IsLoaded
    {
        get
        {
            return _MaintACClassProperty_VBiACClassProperty != null;
        }
    }

    public virtual CollectionEntry<ACClassProperty, MaintACClassProperty> MaintACClassProperty_VBiACClassPropertyReference
    {
