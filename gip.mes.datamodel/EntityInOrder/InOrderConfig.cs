...
namespace gip.mes.datamodel
{
    ...
    /// InOrderConfig
    /// </summary>
    [ACClassInfo(Const.PackName_VarioPurchase, "en{'InOrder.config'}de{'InOrder.config'}", Global.ACKinds.TACDBA, Global.ACStorableTypes.NotStorable, false, true)]
    ...
    public partial class InOrderConfig : IACConfig
    {
        ...
        /// </summary>
        public static InOrderConfig NewACObject(DatabaseApp dbApp, IACObject parentACObject)
        {
            InOrderConfig entity = new InOrderConfig();
            entity.InOrderConfigID = Guid.NewGuid();
        ...
        /// <summary>InOrderConfig-Childs</summary>
        /// <value>InOrderConfig-Childs</value>
        public IEnumerable<IACContainerWithItems> Items
        {
            get
            {
                return InOrderConfig_ParentInOrderConfig;
            }
        }
        ...
        public IACContainerWithItems ParentContainer
        {
            get
            {
                return InOrderConfig1_ParentInOrderConfig;
            }
        }
        ...
        public IACContainerWithItems RootContainer
        {
            get
            {
                if (InOrderConfig1_ParentInOrderConfig == null)
                    return this;
                return InOrderConfig1_ParentInOrderConfig.RootContainer;
            }
        }
        ...
        {
            if (child is InOrderConfig)
            {
                InOrderConfig InOrderConfig = child as InOrderConfig;
                InOrderConfig.InOrderConfig1_ParentInOrderConfig = this;
                InOrderConfig_ParentInOrderConfig.Add(InOrderConfig);
            }
        }
        ...
        public bool Remove(IACContainerWithItems child)
        {
            if (child is InOrderConfig)
            {
                return InOrderConfig_ParentInOrderConfig.Remove(child as InOrderConfig);
            }
            return false;
        }
