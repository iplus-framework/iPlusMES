...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(5, "MDInOrderType", ConstApp.ESInOrderType, Const.ContextDatabase + "\\MDInOrderType", "", true)]
    [ACPropertyEntity(6, "MDInRequestState", ConstApp.ESInRequestState, Const.ContextDatabase + "\\MDInRequestState", "", true)]
    [ACPropertyEntity(7, "DistributorCompany", "en{'DistributorCompany'}de{'Lieferant'}", Const.ContextDatabase + "\\" + Company.ClassName, "", true)]
    ...
    public partial class InRequest : IACConfigStore
    {
        ...
        private SafeList<IACConfig> ACConfigListCache
        {
            get
            {
                ...
                if (InRequestConfig_InRequest.IsLoaded)
                {
                    InRequestConfig_InRequest.AutoRefresh();
                    InRequestConfig_InRequest.AutoLoad();
                }
