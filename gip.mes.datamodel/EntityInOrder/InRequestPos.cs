...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(11, MDTimeRange.ClassName, ConstApp.ESTimeRange, Const.ContextDatabase + "\\" + MDTimeRange.ClassName, "", true)]
    [ACPropertyEntity(12, "PriceNet", ConstApp.PriceNet, "", "", true)]
    [ACPropertyEntity(13, "PriceGross", ConstApp.PriceGross, "", "", true)]
    [ACPropertyEntity(14, MDCountrySalesTax.ClassName, "en{'Sales tax'}de{'Steuersatz'}", Const.ContextDatabase + "\\" + MDCountrySalesTax.ClassName, "", true)]
    ...
    [ACPropertyEntity(9999, "InRequest", "en{'Quotation'}de{'Anfrage'}", Const.ContextDatabase + "\\InRequest", "", true)]
