...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(4, MDInOrderType.ClassName, "en{'Purchase Order Type'}de{'Bestellart'}", Const.ContextDatabase + "\\" + MDInOrderType.ClassName, "", true)]
    [ACPropertyEntity(5, MDInOrderState.ClassName, "en{'Purchase Order Status'}de{'Bestellstatus'}", Const.ContextDatabase + "\\" + MDInOrderState.ClassName, "", true)]
    [ACPropertyEntity(6, "DistributorCompany", "en{'Distributor'}de{'Lieferant'}", Const.ContextDatabase + "\\" + Company.ClassName, "", true)]
