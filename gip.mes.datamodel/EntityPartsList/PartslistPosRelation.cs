...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(4, "SourcePartslistPos", "en{'Sub-Item from'}de{'Unterposition von'}", Const.ContextDatabase + "\\PartslistPos" + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(5, "TargetPartslistPos", "en{'Intermediate Product'}de{'Zwischenprodukt'}", Const.ContextDatabase + "\\PartslistPos" + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(6, "MaterialWFRelation", "en{'MaterialWFRelation'}de{'MaterialWFRelation'}", Const.ContextDatabase + "\\MaterialWFRelation" + Const.DBSetAsEnumerablePostfix, "", true)]
