...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(6, MDToleranceState.ClassName, "en{'Tolerance Status'}de{'Toleranzstatus'}", Const.ContextDatabase + "\\" + MDToleranceState.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(7, MDProdOrderPartslistPosState.ClassName, "en{'Status'}de{'Status'}", Const.ContextDatabase + "\\" + MDProdOrderPartslistPosState.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(8, ProdOrderBatch.ClassName, "en{'Batch'}de{'Charge'}", Const.ContextDatabase + "\\" + ProdOrderBatch.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(9, "SourceProdOrderPartslistPos", "en{'Subitem from'}de{'Unterposition von'}", Const.ContextDatabase + "\\" + ProdOrderPartslistPos.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(10, "TargetProdOrderPartslistPos", "en{'Intermediate Product'}de{'Zwischenprodukt'}", Const.ContextDatabase + "\\" + ProdOrderPartslistPos.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(11, "ParentProdOrderPartslistPosRelation", "en{'Partial Quantity from'}de{'Teilmenge von'}", Const.ContextDatabase + "\\" + ProdOrderPartslistPosRelation.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
