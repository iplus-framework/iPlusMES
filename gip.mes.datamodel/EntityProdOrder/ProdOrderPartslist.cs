...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(1, nameof(Sequence), "en{'Sort'}de{'Sortierung'}", "", "", true)]
    [ACPropertyEntity(2, nameof(Partslist), "en{'Bill of Materials Master'}de{'Stamm-Stückliste'}", Const.ContextDatabase + "\\" + Partslist.ClassName, "", true)]
    [ACPropertyEntity(3, nameof(ProdOrder), "en{'Production Order'}de{'Produktionsauftrag'}", Const.ContextDatabase + "\\" + ProdOrder.ClassName, "", true)]
    [ACPropertyEntity(4, nameof(MDProdOrderState), "en{'Production Status'}de{'Produktionsstatus'}", Const.ContextDatabase + "\\" + MDProdOrderState.ClassName, "", true)]
    [ACPropertyEntity(5, nameof(DepartmentUserDate), "en{'Ended by User on'}de{'Beendet von Bediener am'}", "", "", true)]
    [ACPropertyEntity(6, nameof(DepartmentUserName), ConstApp.DepartmentUserName, "", "", true)]
    [ACPropertyEntity(7, nameof(StartDate), ConstApp.ProductionStart, "", "", true)]
    [ACPropertyEntity(8, nameof(EndDate), ConstApp.ProductionEnd, "", "", true)]
    ...
    [ACPropertyEntity(11, nameof(LossComment), "en{'Comment'}de{'Bemerkung'}", "", "", true)]
    [ACPropertyEntity(12, nameof(TargetQuantity), ConstApp.TargetQuantity, "", "", true)]
    [ACPropertyEntity(13, nameof(ActualQuantity), ConstApp.ActualQuantity, "", "", true)]
    [ACPropertyEntity(14, nameof(ExternProdOrderNo), "en{'Ext prod. ord. No'}de{'Ext FANr'}", "", "", true)]
    [ACPropertyEntity(15, nameof(LastFormulaChange), "en{'Last formula change'}de{'Letzte Formeländerung'}", "", "", true)]
