...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(1, "MaterialNo", ConstApp.MaterialNo, "", "", true, MinLength = 1)]
    [ACPropertyEntity(2, "MaterialName1", ConstApp.MaterialName1, "", "", true)]
    [ACPropertyEntity(3, "MaterialName2", ConstApp.MaterialName2, "", "", true)]
    [ACPropertyEntity(4, "MaterialName3", ConstApp.MaterialName3, "", "", true)]
    [ACPropertyEntity(5, MDMaterialGroup.ClassName, "en{'Material Group'}de{'Materialgruppe'}", Const.ContextDatabase + "\\" + MDMaterialGroup.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(6, MDMaterialType.ClassName, "en{'Material Type'}de{'Materialart'}", Const.ContextDatabase + "\\" + MDMaterialType.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(7, "BaseMDUnit", "en{'Base Unit of Measure (UOM)'}de{'Basismengeneinheit'}", Const.ContextDatabase + "\\MDUnitList", "", true)]
    [ACPropertyEntity(9, "NetWeight", "en{'Net Weight'}de{'Nettogewicht'}", "", "", true)]
    [ACPropertyEntity(10, "GrossWeight", "en{'Gross Weight'}de{'Bruttogewicht'}", "", "", true)]
    [ACPropertyEntity(11, "ProductionWeight", "en{'Production Weight'}de{'Produktionsgewicht'}", "", "", true)]
    [ACPropertyEntity(12, "Comment", ConstApp.Comment, "", "", true)]
    [ACPropertyEntity(13, "Density", "en{'Density [g/dm³]'}de{'Dichte [g/dm³]'}", "", "", true)]
    [ACPropertyEntity(14, "IsActive", ConstApp.IsActive, "", "", true)]
    [ACPropertyEntity(16, "DontAllowNegativeStock", "en{'No negative Stock'}de{'Kein negativer Bestand'}", "", "", true)]
    [ACPropertyEntity(17, "InFacility", "en{'In Storage Location'}de{'Eingangslager'}", Const.ContextDatabase + "\\" + Facility.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(18, "OutFacility", "en{'Out Storage Location'}de{'Ausgangslager'}", Const.ContextDatabase + "\\" + Facility.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(19, MDGMPMaterialGroup.ClassName, "en{'GMP-Material Group'}de{'GMP-Materialgruppe'}", Const.ContextDatabase + "\\" + MDGMPMaterialGroup.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(20, MDInventoryManagementType.ClassName, "en{'Inventory Mgmt. Type'}de{'Inventurverwaltungsart'}", Const.ContextDatabase + "\\" + MDInventoryManagementType.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(21, "MDFacilityManagementType", "en{'Facility Mgmt. Type'}de{'Lagerführungsart'}", Const.ContextDatabase + "\\" + MDFacilityManagementType.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(22, "MinStockQuantity", ConstApp.MinStockQuantity, "", "", true)]
    [ACPropertyEntity(23, "OptStockQuantity", ConstApp.OptStockQuantity, "", "", true)]
    [ACPropertyEntity(24, "Material1_ProductionMaterial", "en{'Production Material'}de{'Produktionsmaterial'}", Const.ContextDatabase + "\\" + Material.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(26, "StorageLife", ConstApp.StorageLife, "", "", true)]
    [ACPropertyEntity(27, "UsageInOrder", "en{'Usage Purchase Order'}de{'Verwendung Bestellung'}", "", "", true)]
    [ACPropertyEntity(28, "UsageOutOrder", "en{'Usage Sales Order'}de{'Verwendung Auftrag'}", "", "", true)]
    [ACPropertyEntity(29, "UsageOwnProduct", "en{'Usage Own Product'}de{'Verwendung Intern'}", "", "", true)]
    [ACPropertyEntity(30, "UsageACProgram", "en{'Usage in Workflow'}de{'Verwendung Workflow'}", "", "", true)]
    ...
    [ACPropertyEntity(36, "Label", "en{'Label'}de{'Label'}", Const.ContextDatabase + "\\Label" + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(37, MaterialWF.ClassName, "en{'Material-WF'}de{'Material-WF'}", Const.ContextDatabase + "\\" + MaterialWF.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(38, "IsIntermediate", "en{'Is an Intermediate'}de{'Ist ein Zwischenprodukt'}", "", "", true)]
    ...
    public partial class Material : IACConfigStore, IACWorkflowNode, IACClassDesignProvider, IImageInfo, ICloneable
    {
        ...
        private SafeList<IACConfig> ACConfigListCache
        {
            get
            {
                ...
                if (MaterialConfig_Material_IsLoaded)
                {
                    MaterialConfig_Material.AutoLoad(MaterialConfig_MaterialReference, this);
                }
