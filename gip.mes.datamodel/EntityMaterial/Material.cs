...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(5, MDMaterialGroup.ClassName, "en{'Material Group'}de{'Materialgruppe'}", Const.ContextDatabase + "\\" + MDMaterialGroup.ClassName, "", true)]
    [ACPropertyEntity(6, MDMaterialType.ClassName, "en{'Material Type'}de{'Materialart'}", Const.ContextDatabase + "\\" + MDMaterialType.ClassName, "", true)]
    ...
    [ACPropertyEntity(17, "InFacility", "en{'In Storage Location'}de{'Eingangslager'}", Const.ContextDatabase + "\\" + Facility.ClassName, "", true)]
    [ACPropertyEntity(18, "OutFacility", "en{'Out Storage Location'}de{'Ausgangslager'}", Const.ContextDatabase + "\\" + Facility.ClassName, "", true)]
    [ACPropertyEntity(19, MDGMPMaterialGroup.ClassName, "en{'GMP-Material Group'}de{'GMP-Materialgruppe'}", Const.ContextDatabase + "\\" + MDGMPMaterialGroup.ClassName, "", true)]
    [ACPropertyEntity(20, MDInventoryManagementType.ClassName, "en{'Inventory Mgmt. Type'}de{'Inventurverwaltungsart'}", Const.ContextDatabase + "\\" + MDInventoryManagementType.ClassName, "", true)]
    [ACPropertyEntity(21, "MDFacilityManagementType", "en{'Facility Mgmt. Type'}de{'Lagerführungsart'}", Const.ContextDatabase + "\\" + MDFacilityManagementType.ClassName, "", true)]
    ...
    [ACPropertyEntity(24, "Material1_ProductionMaterial", "en{'Production Material'}de{'Produktionsmaterial'}", Const.ContextDatabase + "\\" + Material.ClassName, "", true)]
    ...
    [ACPropertyEntity(36, "Label", "en{'Label'}de{'Label'}", Const.ContextDatabase + "\\Label", "", true)]
    [ACPropertyEntity(37, MaterialWF.ClassName, "en{'Material-WF'}de{'Material-WF'}", Const.ContextDatabase + "\\" + MaterialWF.ClassName, "", true)]
