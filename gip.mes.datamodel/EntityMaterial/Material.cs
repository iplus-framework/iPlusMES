...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(5, nameof(MDMaterialGroup), "en{'Material Group'}de{'Materialgruppe'}", Const.ContextDatabase + "\\" + MDMaterialGroup.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(6, nameof(MDMaterialType), "en{'Material Type'}de{'Materialart'}", Const.ContextDatabase + "\\" + MDMaterialType.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(17, nameof(InFacility), "en{'In Storage Location'}de{'Eingangslager'}", Const.ContextDatabase + "\\" + Facility.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(18, nameof(OutFacility), "en{'Out Storage Location'}de{'Ausgangslager'}", Const.ContextDatabase + "\\" + Facility.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(19, nameof(MDGMPMaterialGroup), "en{'GMP-Material Group'}de{'GMP-Materialgruppe'}", Const.ContextDatabase + "\\" + MDGMPMaterialGroup.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(20, nameof(MDInventoryManagementType), "en{'Inventory Mgmt. Type'}de{'Inventurverwaltungsart'}", Const.ContextDatabase + "\\" + MDInventoryManagementType.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(21, nameof(MDFacilityManagementType), "en{'Facility Mgmt. Type'}de{'Lagerführungsart'}", Const.ContextDatabase + "\\" + MDFacilityManagementType.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(24, nameof(Material1_ProductionMaterial), "en{'Production Material'}de{'Produktionsmaterial'}", Const.ContextDatabase + "\\" + Material.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
    ...
    [ACPropertyEntity(36, nameof(Label), "en{'Label'}de{'Label'}", Const.ContextDatabase + "\\Label" + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(37, nameof(MaterialWF), "en{'Material-WF'}de{'Material-WF'}", Const.ContextDatabase + "\\" + MaterialWF.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
