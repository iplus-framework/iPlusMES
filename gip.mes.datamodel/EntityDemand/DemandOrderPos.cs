...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(8, Partslist.ClassName, "en{'Bill of Materials'}de{'Stückliste'}", Const.ContextDatabase + "\\" + Partslist.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
        ...
        public static DemandOrderPos NewACObject(DatabaseApp dbApp, IACObject parentACObject)
        {
            ...
            if (parentACObject is DemandOrder)
            {
                ...
                if (demandOrder != null)
                {
                    try
                    {
                        if (!demandOrder.DemandOrderPos_DemandOrder_IsLoaded)
                            demandOrder.DemandOrderPos_DemandOrder.AutoLoad(demandOrder.DemandOrderPos_DemandOrderReference, demandOrder);
                    }
                    catch (Exception ec)
                    {
