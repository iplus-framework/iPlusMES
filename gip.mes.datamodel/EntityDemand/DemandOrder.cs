...
namespace gip.mes.datamodel
{
    ...
    [ACPropertyEntity(4, "MDDemandOrderState", "en{'Demandorderstate'}de{'Anforderungsauftragsstatus'}", Const.ContextDatabase + "\\MDDemandOrderState" + Const.DBSetAsEnumerablePostfix, "", true)]
    [ACPropertyEntity(5, "TenantCompany", "en{'Tenant'}de{'Besitzer'}", Const.ContextDatabase + "\\" + Company.ClassName + Const.DBSetAsEnumerablePostfix, "", true)]
