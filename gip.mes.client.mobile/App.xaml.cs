...
namespace gip.mes.client.mobile
{
    ...
    public partial class App : Application
    {
        ...
        public void applicationInitialize(Login loginWindow)
        {
            ...
            string UserName = "";
            string PassWord = "";
            eWpfTheme wpfTheme = gip.mes.client.mobile.Properties.Settings.Default.WpfTheme;
            ControlManager.RestoreWindowsOnSameScreen = gip.mes.client.mobile.Properties.Settings.Default.RestoreWindowsOnSameScreen;
            ControlManager.TouchScreenMode = gip.mes.client.mobile.Properties.Settings.Default.TouchScreenMode;

            if (!cmLineArg.Contains("/autologin"))
            {
                UserName = gip.mes.client.mobile.Properties.Settings.Default.User;
#if DEBUG
                PassWord = gip.mes.client.mobile.Properties.Settings.Default.Password;
#endif
            }
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                if (result == 1)
                {
                    if (!cmLineArg.Contains("/autologin"))
                    {
                        gip.mes.client.mobile.Properties.Settings.Default.User = UserName;
#if DEBUG
                        gip.mes.client.mobile.Properties.Settings.Default.Password = PassWord;
#endif
                        gip.mes.client.mobile.Properties.Settings.Default.WpfTheme = wpfTheme;
                        gip.mes.client.mobile.Properties.Settings.Default.RestoreWindowsOnSameScreen = ControlManager.RestoreWindowsOnSameScreen;
                        gip.mes.client.mobile.Properties.Settings.Default.TouchScreenMode = ControlManager.TouchScreenMode;
                        gip.mes.client.mobile.Properties.Settings.Default.Save();
                    }
