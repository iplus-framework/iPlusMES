...
{
    public class BatchPlanTimelineItem : IACObject
    {
        #region c'tors

        public BatchPlanTimelineItem()
        {
        ...
        internal List<BatchPlanTimelineItem> _Items;

        /// <summary>
        /// Gets the child items.
        /// </summary>
        public List<BatchPlanTimelineItem> Items
        {
            get
            {
                if (_Items == null)
                    _Items = new List<BatchPlanTimelineItem>();
                return _Items;
            }
        }
        ...
        public BatchPlanTimelineItemType TimelineItemType
        {
            get;
            set;
        }
        ...
        public enum BatchPlanTimelineItemType : short
        {
            TimelineItem = 10,
            ContainerItem = 20
        }
