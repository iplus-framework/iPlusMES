...
namespace gip.bso.masterdata
{
    ...
    public class MDBSOInOrderType : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction("MDInOrderType", "en{'New'}de{'Neu'}", (short)MISort.New, true, "SelectedInOrderType", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
            if (!PreExecute("New")) return;
            CurrentInOrderType = MDInOrderType.NewMDInOrderType(DatabaseApp);
            DatabaseApp.MDInOrderType.AddObject(CurrentInOrderType);
            ACState = Const.SMNew;
            PostExecute("New");
        ...
        /// </summary>
        [ACMethodInteraction("MDInOrderType", "en{'Delete'}de{'Löschen'}", (short)MISort.Delete, true, "CurrentInOrderType", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
        ...
        public void Search()
        {
            ...
            OnPropertyChanged("InOrderTypeList");
        }
