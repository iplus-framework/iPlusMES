        ...
        protected override bool HandleExecuteACMethod(out object result, AsyncMethodInvocationMode invocationMode, string acMethodName, core.datamodel.ACClassMethod acClassMethod, params object[] acParameter)
        {
            ...
            switch (acMethodName)
            {
                ...
                case "Search":
                    Search();
                    return true;
                case "LoadGMPMaterialGroupPos":
                    LoadGMPMaterialGroupPos();
                    return true;
                case "IsEnabledLoadGMPMaterialGroupPos":
                    result = IsEnabledLoadGMPMaterialGroupPos();
                    return true;
                case "DeleteGMPMaterialGroupPos":
                    DeleteGMPMaterialGroupPos();
                    return true;
                case "IsEnabledDeleteGMPMaterialGroupPos":
                    result = IsEnabledDeleteGMPMaterialGroupPos();
                    return true;
                case "NewGMPMaterialGroupPos":
                    NewGMPMaterialGroupPos();
                    return true;
                case "IsEnabledNewGMPMaterialGroupPos":
