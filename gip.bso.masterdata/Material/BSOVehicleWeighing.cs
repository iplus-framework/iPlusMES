...
namespace gip.bso.masterdata
{
    ...
    public class BSOVehicleWeighing : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction("InDeliveryNotePosInWeighing", "en{'New'}de{'Neu'}", (short)MISort.New, true, "SelectedInDeliveryNotePosInWeighing", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
        ...
        /// </summary>
        [ACMethodInteraction("InDeliveryNotePosInWeighing", "en{'Delete'}de{'Löschen'}", (short)MISort.Delete, true, "CurrentInDeliveryNotePosInWeighing", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
