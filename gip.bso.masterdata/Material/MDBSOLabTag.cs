...
namespace gip.bso.masterdata
{
    ...
    public class MDBSOLabTag : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction("MDLabTag", "en{'New'}de{'Neu'}", (short)MISort.New, true, "SelectedLabTag", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
        ...
        /// </summary>
        [ACMethodInteraction("MDLabTag", "en{'Delete'}de{'Löschen'}", (short)MISort.Delete, true, "CurrentLabTag", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
