...
namespace gip.bso.masterdata
{
    ...
    public class MDBSODelivPosLoadState : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction(MDDelivPosLoadState.ClassName, "en{'New'}de{'Neu'}", (short)MISort.New, true, "SelectedDelivPosLoadState", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
        ...
        /// </summary>
        [ACMethodInteraction(MDDelivPosLoadState.ClassName, "en{'Delete'}de{'Löschen'}", (short)MISort.Delete, true, "CurrentDelivPosLoadState", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
