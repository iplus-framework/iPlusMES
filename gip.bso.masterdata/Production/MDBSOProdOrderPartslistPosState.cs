...
namespace gip.bso.masterdata
{
    ...
    public class MDBSOProdOrderPartslistPosState : ACBSOvbNav
    {
        ...
        public void New()
        {
            ...
            DatabaseApp.MDProdOrderPartslistPosState.AddObject(CurrentProdOrderPartslistPosState);
            ACState = Const.SMNew;
            PostExecute("New");
        ...
        public void Search()
        {
            ...
            OnPropertyChanged("ProdOrderPartslistPosStateList");
        }
        ...
        protected override bool HandleExecuteACMethod(out object result, AsyncMethodInvocationMode invocationMode, string acMethodName, core.datamodel.ACClassMethod acClassMethod, params object[] acParameter)
        {
            ...
            switch (acMethodName)
            {
                ...
                case "Delete":
                    Delete();
                    return true;
                case "IsEnabledDeleteProdOrderPartslistPosState":
