...
namespace gip.bso.masterdata
{
    ...
    public class MDBSOToleranceState : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction(MDToleranceState.ClassName, "en{'New'}de{'Neu'}", (short)MISort.New, true, "SelectedToleranceState", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
        ...
        /// </summary>
        [ACMethodInteraction(MDToleranceState.ClassName, "en{'Delete'}de{'Löschen'}", (short)MISort.Delete, true, "CurrentToleranceState", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
        ...
        public void Search()
        {
            ...
            OnPropertyChanged("ToleranceStateList");
        }
