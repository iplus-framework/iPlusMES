...
namespace gip.bso.masterdata
{
    ...
    public class MDBSODemandOrderState : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction("MDDemandOrderState", Const.New, (short)MISort.New, true, "SelectedDemandOrderState", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
            if (!PreExecute("New")) return;
            CurrentDemandOrderState = MDDemandOrderState.NewACObject(DatabaseApp, null);
            DatabaseApp.MDDemandOrderState.AddObject(CurrentDemandOrderState);
            ACState = Const.SMNew;
            PostExecute("New");
        ...
        /// </summary>
        [ACMethodInteraction("MDDemandOrderState", Const.Delete, (short)MISort.Delete, true, "CurrentDemandOrderState", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
        ...
        public override IEnumerable<string> GetPropsToObserveForIsEnabled(string acMethodName)
        {
            switch (acMethodName)
            {
                ...
                case nameof(Load):
                case nameof(IsEnabledLoad):
                    return new string[] { nameof(ACState), nameof(SelectedDemandOrderState) };
                #endregion
                ...
                case nameof(Delete):
                case nameof(IsEnabledDelete):
                    return new string[] { nameof(CurrentDemandOrderState) };
                #endregion
            }
