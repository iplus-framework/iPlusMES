        ...
        protected override bool HandleExecuteACMethod(out object result, AsyncMethodInvocationMode invocationMode, string acMethodName, core.datamodel.ACClassMethod acClassMethod, params object[] acParameter)
        {
            ...
            switch (acMethodName)
            {
                ...
                case"Search":
                    Search();
                    return true;
                case"LoadVehicleContainer":
                    LoadVehicleContainer();
                    return true;
                case"IsEnabledLoadVehicleContainer":
                    result = IsEnabledLoadVehicleContainer();
                    return true;
                case"NewVehicleContainer":
                    NewVehicleContainer();
                    return true;
                case"IsEnabledNewVehicleContainer":
                    result = IsEnabledNewVehicleContainer();
                    return true;
                case"DeleteVehicleContainer":
                    DeleteVehicleContainer();
                    return true;
                case"IsEnabledDeleteVehicleContainer":
