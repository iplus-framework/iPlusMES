...
namespace gip.bso.masterdata
{
    ...
    public class MDBSOMovementReason : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction(MDMovementReason.ClassName, Const.New, (short)MISort.New, true, "SelectedMovementReason", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
        ...
        /// </summary>
        [ACMethodInteraction(MDMovementReason.ClassName, Const.Delete, (short)MISort.Delete, true, "CurrentMovementReason", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
        ...
        public override IEnumerable<string> GetPropsToObserveForIsEnabled(string acMethodName)
        {
            switch (acMethodName)
            {
                ...
                case nameof(Load):
                    return new string[] { nameof(ACState), nameof(SelectedMovementReason) };
                case nameof(Delete):
                    return new string[] { nameof(CurrentMovementReason) };
                case nameof(New):
