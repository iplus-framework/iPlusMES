...
// ***********************************************************************
// <copyright file="BSOReservFacilityLocation.cs" company="gip mbh, Oftersheim, Germany">
...
namespace gip.bso.masterdata
{
    ...
    /// 1. Reservierungen-&gt;Lagerort Reservierungen
    /// Neue Masken:
    /// 1. Lagerort Reservierungen
    /// </summary>
    [ACClassInfo(Const.PackName_VarioFacility, "en{'Facility Location Reservation'}de{'Lagerort Reservierung'}", Global.ACKinds.TACBSO, Global.ACStorableTypes.NotStorable, true, true)]
    class BSOReservFacilityLocation : ACBSOvb
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BSOReservFacilityLocation"/> class.
        /// </summary>
        ...
        public BSOReservFacilityLocation(gip.core.datamodel.ACClass acType, IACObject content, IACObject parentACObject, ACValueList parameter, string acIdentifier = "")
        ...
        /// </summary>
        /// <value>The facility location filter.</value>
        public Facility FacilityLocationFilter
        {
            get
            {
                return CurrentFacilityReservationData.FacilityLocationFilter;
            }
        }
        ...
        /// </summary>
        [ACMethodInfo("FacilityReservationData", "en{'Search'}de{'Suchen'}", (short)MISort.Search)]
        public void Search()
        {
            CurrentFacilityReservationData.FacReservationSearchType = FacilityReservationData.FacReservationSearchTypes.SearchByFacilityLocation;
