...
namespace gip.bso.masterdata
{
    ...
    public class MDBSOCountry : ACBSOvbNav
    {
        ...
        public override async Task<bool> ACDeInit(bool deleteACClassTask = false)
        {
            ...
            {
                await _AccessCountryLand.ACDeInit(false);
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction(MDCountry.ClassName, Const.New, (short)MISort.New, true, "SelectedCountry", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
        ...
        /// </summary>
        [ACMethodInteraction(MDCountry.ClassName, Const.Delete, (short)MISort.Delete, true, "CurrentCountry", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
