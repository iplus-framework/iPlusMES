...
namespace gip.bso.masterdata
{
    ...
    public class BSOCompany : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction(Company.ClassName, "en{'New'}de{'Neu'}", (short)MISort.New, true, "SelectedCompany", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
        ...
        /// </summary>
        [ACMethodInteraction(Company.ClassName, "en{'Delete'}de{'Löschen'}", (short)MISort.Delete, true, "CurrentCompany", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
