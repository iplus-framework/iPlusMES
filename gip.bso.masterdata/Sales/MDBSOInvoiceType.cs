...
namespace gip.bso.masterdata
{
    ...
    public class MDBSOInvoiceType : ACBSOvbNav
    {
        ...
        public void New()
        {
            ...
            DatabaseApp.MDInvoiceType.AddObject(CurrentMDInvoiceType);
            ACState = Const.SMNew;
            PostExecute("New");
        ...
        public override IEnumerable<string> GetPropsToObserveForIsEnabled(string acMethodName)
        {
            switch (acMethodName)
            {
                ...
                case nameof(Load):
                case nameof(IsEnabledLoad):
                    return new string[] { nameof(ACState), nameof(SelectedMDInvoiceType) };
                #endregion
                ...
                case nameof(Delete):
                case nameof(IsEnabledDelete):
                    return new string[] { nameof(CurrentMDInvoiceType) };
                #endregion
            }
