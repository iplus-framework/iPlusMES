...
namespace gip.bso.masterdata
{
    ...
    public class MDBSOOutOrderPosState : ACBSOvbNav
    {
        ...
        /// News this instance.
        /// </summary>
        [ACMethodInteraction(MDOutOrderPosState.ClassName, "en{'New'}de{'Neu'}", (short)MISort.New, true, "SelectedOutOrderPosState", Global.ACKinds.MSMethodPrePost)]
        public void New()
        {
            if (!PreExecute("New")) return;
            CurrentOutOrderPosState = MDOutOrderPosState.NewACObject(DatabaseApp, null);
            DatabaseApp.MDOutOrderPosState.AddObject(CurrentOutOrderPosState);
            ACState = Const.SMNew;
            PostExecute("New");
        ...
        /// </summary>
        [ACMethodInteraction(MDOutOrderPosState.ClassName, "en{'Delete'}de{'Löschen'}", (short)MISort.Delete, true, "CurrentOutOrderPosState", Global.ACKinds.MSMethodPrePost)]
        public void Delete()
        {
        ...
        protected override bool HandleExecuteACMethod(out object result, AsyncMethodInvocationMode invocationMode, string acMethodName, core.datamodel.ACClassMethod acClassMethod, params object[] acParameter)
        {
            ...
            switch (acMethodName)
            {
                ...
                case "Delete":
                    Delete();
                    return true;
                case "IsEnabledDeleteOutOrderPosState":
