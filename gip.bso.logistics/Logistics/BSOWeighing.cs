        ...
        private IQueryable<Weighing> _AccessPrimary_NavSearchExecuting(IQueryable<Weighing> result)
        {
            ...
            return result
                .Where(c =>
                    ...
                    (FilterIsPicking == null || (FilterIsPicking == true && c.PickingPosID != null) || (FilterIsPicking == false && c.PickingPosID == null))
                    && (FilterIsInOrder == null || (FilterIsInOrder == true && c.InOrderPosID != null) || (FilterIsInOrder == false && c.InOrderPosID == null))
                    && (FilterIsOutOrder == null || (FilterIsOutOrder == true && c.OutOrderPosID != null) || (FilterIsOutOrder == false && c.OutOrderPosID == null))
                    && (FilterIsLabOrder == null || (FilterIsLabOrder == true && c.LabOrderPosID != null) || (FilterIsLabOrder == false && c.LabOrderPosID == null))
                    && (FilterIsVisitorVoucher == null || (FilterIsVisitorVoucher == true && c.VisitorVoucherID != null) || (FilterIsVisitorVoucher == false && c.VisitorVoucherID == null))
