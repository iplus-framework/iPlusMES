...
{
    [ACClassInfo(Const.PackName_TwinCAT, "en{'TwinCAT Ser. Mixing'}de{'TwinCAT Ser. Mischen'}", Global.ACKinds.TACDAClass, Global.ACStorableTypes.NotStorable, false, false)]
