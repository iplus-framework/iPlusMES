...
{
    [ACClassInfo(Const.PackName_TwinCAT, "en{'Serializer for Vacuum'}de{'Serialisierer für Vakuum'}", Global.ACKinds.TACDAClass, Global.ACStorableTypes.Required, false, false)]
