...
namespace gip.mes.processapplication
{
    public partial class PWDosing
    {
                ...
                foreach (PickingPos pickingPos in openPickings)
                {
                    ...
                    else
                    {
                        ACRoutingParameters rParameters = new ACRoutingParameters()
                        {
                            ...
                            SelectionRuleID = PAMSilo.SelRuleID_SiloDirect,
                            DBSelector = (c, p, r) => c.ACKind == Global.ACKinds.TPAProcessModule && pickingPos.FromFacility.VBiFacilityACClassID == c.ACClassID,
                            DBDeSelector = (c, p, r) => c.ACKind == Global.ACKinds.TPAProcessModule && c.ACClassID != scaleACClassID, // Breche Suche ab sobald man bei einem Vorg�nger der ein Silo oder Waage angelangt ist
                            MaxRouteAlternativesInLoop = ACRoutingService.DefaultAlternatives,
                            IncludeReserved = true,
                            IncludeAllocated = true,
                            DBRecursionLimit = 10
        ...
        private bool ManageDosingStatePicking(ManageDosingStatesMode mode, DatabaseApp dbApp, out double sumQuantity)
        {
            ...
            // Falls noch Dosierungen anstehen, dann dosiere n�chste Komponente
                            ...
                            else if (facilityPreBooking != null)
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        // => Es muss die selbe Menge wieder zur�ckgebucht werden auf ein Sonderlagerplatz
                                    ...
                                    && outwardFacility.ReservedQuantity > -0.0001) // Prevent setting to zero stock. Used for virtual silos like city water that never shorts
                            {
                                ...
                                if (!anyOtherFunctionActiveFromThisSilo)
                                {
                                    ...
                                    if (!hasQuants && outwardFacility != null && outwardFacility.Material != null && !outwardFacility.ShouldLeaveMaterialOccupation)
                                    {
                                        ...
                                        {
                                            outwardFacility.Material = null; // Automatisches L�schen der Belegung?
        ...
        /// <summary>
        /// 4.2 Benachrichtigungsmethode, dass Siloabbuchung stattgefunden hat. Hier kann die Subclass noch zus�tzliche stati setzten
        /// Falls Silo leer und das Silo leergebucht werden soll, dann muss true zur�ckgegeben werden andernfalls kann mit false die Mullbestandsbuchung in der Basisklasse ausgeschaltet werden
        /// </summary>
        ...
        /// <summary>
        /// 4.3 Benachrichtigungsmethode f�r Subclass, dass aktuelles Silo auf Nullbestand gebucht worden ist
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Hilfsmethode um eine Entnahmebuchung von dem urspr�nglichen Silo in ein Sonderziel zurckzubuchen
        /// </summary>
        /// <param name="dbApp"></param>
