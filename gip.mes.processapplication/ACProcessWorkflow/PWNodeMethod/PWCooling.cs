...
{
    [ACClassInfo(Const.PackName_VarioAutomation, "en{'Cooling'}de{'Kühlen'}", Global.ACKinds.TPWNodeMethod, Global.ACStorableTypes.Optional, false, PWMethodVBBase.PWClassName, true)]
