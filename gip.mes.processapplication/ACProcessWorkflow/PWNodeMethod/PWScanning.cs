...
{
    [ACClassInfo(Const.PackName_VarioAutomation, "en{'PWScanning'}de{'PWScanning'}", Global.ACKinds.TPWNodeMethod, Global.ACStorableTypes.Optional, false, PWMethodVBBase.PWClassName, true)]
