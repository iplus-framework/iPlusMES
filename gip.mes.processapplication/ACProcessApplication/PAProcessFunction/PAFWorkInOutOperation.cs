...
namespace gip.mes.processapplication
{
    ...
    public class PAFWorkInOutOperation : PAFWorkTaskScanBase
    {
        ...
        public override WorkTaskScanResult OnScanEvent(BarcodeSequenceBase sequence, PAProdOrderPartslistWFInfo selectedPOLWf, Guid facilityChargeID, int scanSequence, short? sQuestionResult, ACMethod acMethod, bool? malfunction)
        {
