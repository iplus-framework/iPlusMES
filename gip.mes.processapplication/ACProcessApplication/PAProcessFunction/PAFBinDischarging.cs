...
namespace gip.mes.processapplication
{
    ...
    public class PAFBinDischarging : PAProcessFunction, IPAFuncScaleConfig
    {
        ...
        public static bool HandleExecuteACMethod_PAFBinDischarging(out object result, IACComponent acComponent, string acMethodName, gip.core.datamodel.ACClassMethod acClassMethod, object[] acParameter)
        {
