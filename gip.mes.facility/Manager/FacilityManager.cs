...
namespace gip.mes.facility
{
    ...
    public partial class FacilityManager : PARole, IFacilityManager
    {
        ...
        static FacilityManager()
        {
            ...
            ACMethod.RegisterVirtualMethod(typeof(FacilityManager), "BookFacility", CreateVirtualChangeExpirationDate(GlobalApp.FBT_Change_ExpirationDate, GlobalApp.FacilityBookingType.Change_ExpirationDate));
        ...
        public ACMethodEventArgs BookFacility(ACMethodBooking BP, DatabaseApp dbApp)
        {
            ...
            // TODO: Replace _ACMethodBooking and othe Members with a kind TransactionToken, so that BookFacility could be executed concurrently
            try
            {
        ...
        private static ACMethodWrapper CreateVirtualChangeExpirationDate(string AcIdentitifer, GlobalApp.FacilityBookingType BookingType)
        {
            ACMethodBooking TMP = new ACMethodBooking();
