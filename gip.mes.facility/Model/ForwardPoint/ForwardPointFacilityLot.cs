...
{
    /// <summary>
    /// Forward Tracing and Tracing process on FacilityLot item
    /// </summary>
    public class ForwardPointFacilityLot : TandTPoint
    {
        /// <summary>
        ...
        /// <param name="fl">FacilityLot as tracking item</param>
        /// <param name="filter">Filter for enable or disable item in tracking tree for display</param>
        public ForwardPointFacilityLot(DatabaseApp dbApp, TandTResult rs, TandTPoint parentPoint, FacilityLot fl, TandTFilter filter)
