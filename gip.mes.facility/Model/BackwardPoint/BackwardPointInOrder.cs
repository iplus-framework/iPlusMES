...
{
    /// <summary>
    /// Backward Tracing and Tracing process on InOrder item
    /// </summary>
    public class BackwardPointInOrder : TandTPoint
    {
        /// <summary>
        ...
        /// <param name="inOrder">InOrder tracked item</param>
        /// <param name="filter">Filter for enable or disable item in tracking tree for display</param>
        public BackwardPointInOrder(DatabaseApp dbApp, TandTResult rs, TandTPoint parentPoint, InOrder inOrder, TandTFilter filter)
