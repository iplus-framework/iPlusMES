...
{
    /// <summary>
    /// Backward Tracing and Tracing process on ProdOrder item
    /// </summary>
    public class BackwardPointProdOrder : TandTPoint
    {
        /// <summary>
        ...
        /// <param name="prodOr">ProdOrder tracked item</param>
        /// <param name="filter">Filter for enable or disable item in tracking tree for display</param>
        public BackwardPointProdOrder(DatabaseApp dbApp, TandTResult rs, TandTPoint parentPoint, ProdOrder prodOr, TandTFilter filter)
