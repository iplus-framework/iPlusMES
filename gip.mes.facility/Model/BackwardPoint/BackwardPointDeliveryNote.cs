...
{
    /// <summary>
    /// Backward Tracing and Tracing process on DeliveryNote item
    /// </summary>
    public class BackwardPointDeliveryNote : TandTPoint
    {
        /// <summary>
        ...
        /// <param name="dn">delivery note tracked item</param>
        /// <param name="filter">Filter for enable or disable item in tracking tree for display</param>
        public BackwardPointDeliveryNote(DatabaseApp dbApp, TandTResult rs, TandTPoint parentPoint, DeliveryNote dn, TandTFilter filter)
